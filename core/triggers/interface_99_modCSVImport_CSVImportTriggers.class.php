...
/**
 * \file    core/triggers/interface_99_modCSVImport_CSVImportTriggers.class.php
 * \ingroup csvimport
 ...
 *      - interface_99_modCSVImport_MyTrigger.class.php
...
/**
 *  Class of triggers for CSVImport module
 */
class InterfaceCSVImportTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "CSVImport triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'csvimport@csvimport';
	}
